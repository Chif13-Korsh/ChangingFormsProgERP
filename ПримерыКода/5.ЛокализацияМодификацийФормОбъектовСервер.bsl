...
Процедура ПриСозданииНаСервере_РеализацияТоваровУслуг_ФормаДокумента(Форма, Отказ, СтандартнаяОбработка)
	...
	ДобавляемыеРеквизиты.Добавить(Новый РеквизитФормы("ВалютаPO", 
		Новый ОписаниеТипов("СправочникСсылка.Валюты"), , "Валюта РО"));
	...
	КнФиксКурс = ДобавитьКнопкуФормы(Форма, "УстановитьПризнакФиксКурса", 
	...
	ГруппаВалютаPO = ДобавитьГруппуФормы(Форма, "ГруппаВалютаPO", 
	...
	ДобавитьПолеФормы(Форма, "ВалютаДоговора", "ВалютаPO", НСтр("ru = 'Валюта PO'"), ГруппаВалютаPO);
	
	ДобавитьПолеФлагаФормы(Форма, "ВнешнийКурс", "Объект.ВнешнийКурс", НСтр("ru = 'Внешний курс'"), ГруппаВалютаPO);
